...
import { calculateSizes } from '../constants.js/index.js'
  ...
  return (
    <section className='min-h-screen w-full flex flex-col relative border-2 border-blue-500'>
      <div className="w-full mx-auto flex flex-col sm:mt-30 mt-20 c-space gap-3">
        <p className='sm:text-3xl text-2xl font-medium text-white text-center font-generalsans'>Hi, I am Enoch <span className="waving-hand">👋</span></p>
